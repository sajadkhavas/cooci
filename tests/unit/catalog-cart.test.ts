...
const backendProductFixture = {
  ...
  name: "توفي شکللابی مواهدنم",
  productCode: "COOKIE-001",
  shortDescription: "توضيح کوتها",
  ...
  shippingNote: "ارسال سراسري",
  ingredients: [],
  allergens: [],
  shelfLife: "۷روز",
  storageTips: "محیط خنک",
  preparationTimeDays: 1,
  badges: [],
  images: [
    {
      url: "https://cdn.example.com/cookie.jpg",
      alt: "کوفي شکللابی مواهدنم",
      verified: true,
    },
  ],
  isFeatured: true,
  ...
  seo: {
    title: "ةوک�� شوکلاتي",
    description: "کوفي شکللابی وينیمي",
  },
...
const catalogProductFixture = {
  ...
  shippingScope: "nationwide",
  shippingNote: "",
  images: [{ url: "/assets/cookie.jpg", alt: "کونی" }],
  isFeatured: true,
  productCode: "COOKIE-001",
  variants: [
    {
