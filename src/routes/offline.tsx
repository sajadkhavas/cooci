...
export default function OfflinePage() {
  ...
  return (
    <section
      data-pwa-offline-shell="true"
      className="container-custom flex min-h-[65vh] items-center justify-center py-16 text-center"
    >
      <div className="max-w-xl rounded-[2rem] border border-[#27390c]/15 bg-white/75 p-8 shadow-soft sm:p-12">
        ...
        <a className="mt-7 inline-flex rounded-full bg-[#d0e596] px-6 py-3 font-black text-[#27390c]" href="">
          تلاش دوباره
        </a>
      </div>
    </section>
