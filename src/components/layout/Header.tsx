...
const isNavLinkActive = (pathname: string, link: NavLink) => {
  switch (link.match) {
    ...
    case "products":
      return (
        pathname === "/products" ||
        (pathname.startsWith("/products/") && !pathname.startsWith("/products/category/"))
      );
    case "categories":
...
export const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-50">
      <div
        className={`overflow-hidden bg-gradient-to-l from-primary via-cocoa to-primary text-center text-sm font-medium text-primary-foreground transition-all duration-300 ease-out ${
      ...
      >
        <div className="container-custom">
          <div className="flex h-16 items-center justify-between gap-2 md:h-20">
            <Link to="/" className="group flex min-w-0 items-center gap-3" aria-label={`${brandConfig.brandName} - صفحه اصلی`}>
              <div className="relative shrink-0">
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-primary via-cocoa to-primary shadow-lg transition-all duration-300 group-hover:scale-105 group-hover:shadow-xl md:h-12 md:w-12">
            ...
            <div className="flex shrink-0 items-center gap-1 md:gap-2">
              <Link
                ...
                className="rounded-xl p-2.5 text-foreground/80 transition-all hover:bg-primary/5 hover:text-primary"
              ...
              <Link
                to="/cart"
                className="relative rounded-xl p-2.5 text-foreground/80 transition-all hover:bg-primary/5 hover:text-primary"
                aria-label={`سبد خرید${totalItems > 0 ? `، ${totalItems.toLocaleString("fa-IR")} محصول` : ""}`}
              >
              ...
              <a
                ...
                className="hidden items-center gap-2 rounded-xl px-3 py-2.5 text-foreground/80 transition-all hover:bg-primary/5 hover:text-primary md:flex"
                aria-label={`تماس با ${brandConfig.brandName}`}
              >
                <Phone size={18} aria-hidden="true" />
                <span className="hidden text-sm font-medium xl:inline">{brandConfig.phone}</span>
              </a>
              ...
              <a
                ...
                className="hidden items-center gap-2 rounded-xl bg-whatsapp px-4 py-2.5 text-sm font-bold text-white shadow-lg transition-all hover:scale-105 hover:shadow-xl md:flex"
              ...
              <button
                ...
                className="rounded-xl bg-secondary/50 p-2.5 text-foreground transition-colors hover:bg-secondary lg:hidden"
          ...
          <div
            ...
            className={`overflow-hidden transition-all duration-500 lg:hidden ${
              isOpen ? "max-h-[700px] opacity-100" : "pointer-events-none max-h-0 opacity-0"
            }`}
          >
