...
const guides = [
  ...
  },
  {
    ...
    description: "محصولات یخچالی نشان مشخص دارند؛ جزئیات نگهداری را قبل از انتخاب بررسی کن.",
    image: lifestyleMilk,
  ...
  },
  {
    ...
    description: "نوع مراسم، تعداد مهمان‌ها و اندازه محصول، مقدار مناسب را روشن‌تر می‌کنند.",
    image: galleryBaking,
