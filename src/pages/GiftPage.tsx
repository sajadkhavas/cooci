...
const occasions = [
  {
    icon: Heart,
    title: "سالگرد و مناسبت شخصی",
    desc: "درخواست کارت و ترکیب پیشنهادی",
  },
  {
    icon: Star,
    title: "تولد و جشن",
    desc: "انتخاب محصول و تعداد متناسب با جشن",
  },
  {
    icon: Gift,
    title: "تشکر و تبریک",
    desc: "درخواست بسته‌بندی هدیه پس از استعلام",
  },
  {
    icon: Sparkles,
    title: "هدیه خانوادگی",
    desc: "ترکیب محصولات موجود فروشگاه",
  },
];
    ...
    <>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-primary/10 via-background to-accent/10 section-padding">
        <div className="container-custom">
          <Breadcrumbs
            className="mb-8"
            items={[{ name: "خانه", href: "/" }, { name: "باکس هدیه" }]}
          />
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div>
              ...
              <h1 className="heading-1 mb-6 text-foreground">
                هدیه‌ای متناسب با مناسبت شما
              </h1>
              <p className="body-large mb-8 leading-9 text-muted-foreground">
                محصولات آماده را از فروشگاه انتخاب کنید. برای کارت، بسته‌بندی یا
                ترکیب اختصاصی، درخواست ثبت کنید تا امکان اجرا، هزینه و زمان
                آماده‌سازی بررسی شود.
              </p>
            ...
            <div className="aspect-square overflow-hidden rounded-3xl shadow-2xl">
              <img
                src={galleryGiftBoxes}
                alt="تصویر نمایشی بسته‌بندی هدیه وینیمی"
