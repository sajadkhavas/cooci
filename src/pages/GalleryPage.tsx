...
const GalleryPage = () => {
  ...
  const query = useQuery({
    ...
    initialData: isBackendEnabled ? loaderData?.galleryItems : undefined,
    staleTime: 5 * 60_000,
  });

  const items = query.data ?? [];

  const indexability = resolveConditionalContentIndexability(items.length);
