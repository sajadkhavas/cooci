...
## کشفیات کیفیت داده و سایت زنده

- SSR خانه و فروشگاه محتوا، دسته‌ها، محصول، قیمت و لینک‌های crawlable را نشان می‌دهد.
- بلاگ در Production پیام «هنوز مقاله‌ای منتشر نشده است» دارد؛ Resource موجود است و این یک کار محتوایی است.
- چند قیمت آزمایشی بسیار پایین و تخفیف ۵۰٪ در خروجی عمومی دیده می‌شود؛ پیش از واقعی‌کردن سایت باید اپراتور قیمت/موجودی/تخفیف محصولات را از «محصولات بیکری» بازبینی کند.
- لینک‌ها و ستون‌های فوتر در بعضی صفحات بدون دسته نمایش داده می‌شوند؛ این با شکاف قرارداد Footer مرتبط است و فقط مشکل داده نیست.
